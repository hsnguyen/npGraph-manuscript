...
To achieve this, we applied DBSCAN clustering algorithm \cite{Ester96adensity-based}, which utilises a customised metric function to map contigs into a one-dimensional space.  In order to 
 define a customised metric which is \cancel{sample} \replace{simple} and fast to calculate, we assumed that a single long contig itself consists of a Poisson distribution of \emph{k-mers} count with the mean approximated by the contig's coverage. 
...
\begin{figure}[!ht]
 ...
 \caption{Alignments of an \emph{Enterobacter~cloacae} reference genome to assembly sequences generated by  (a)~\cancel{\unicycler{}}\replace{\npgraph{}} and (b)~\cancel{\npgraph{}}\replace{\unicycler{}}. The former suggests a structural variant, the latter is virtually an 1-to-1 mapping.}
\end{figure}

\clearpage
\paragraph*{S1 Table.}
\label{S1_Table}
Benchmarking different methods using $\mathtt{\replace{lrscaf}}$, \npscarf{}, \npgraph{}, $\mathtt{hybridSPAdes}$ and \unicycler{} hybrid assembler with the synthetic data set.
...
\nobreakmidrule
\rowcolor{Gray}
& \replace{lrscaf} & \replace{-} & \replace{-} & \replace{-} & \replace{-} & \replace{-} & \replace{-} \\*
\rowcolor{Gray}
...
\nobreakmidrule
& \replace{lrscaf} & \replace{4113104} & \replace{6} & \replace{4002298} & \replace{0} & \replace{0.00} & \replace{0.00}\\*
...
\nobreakmidrule
\rowcolor{Gray}
& \replace{lrscaf} & \replace{4119020} & \replace{12} & \replace{4002117} & \replace{0} & \replace{0.03} & \replace{0.79}\\* 
\rowcolor{Gray}
...
\nobreakmidrule
& \replace{lrscaf} & \replace{3896799} & \replace{4} & \replace{3886381} & \replace{0} & \replace{0.47} & \replace{
0.36}\\*
...
\nobreakmidrule
\rowcolor{Gray}
& \replace{lrscaf} & \replace{4367657} & \replace{27} & \replace{1035967} & \replace{13} & \replace{30.11} & \replace{1.42}\\* 
\rowcolor{Gray}
...
\nobreakmidrule
& \replace{lrscaf} & \replace{4732001} & \replace{16} & \replace{692794} & \replace{7} & \replace{3.42} & \replace{0.58}\\*
...
\nobreakmidrule
\rowcolor{Gray}
& \replace{lrscaf} & \replace{5410854} & \replace{21} & \replace{910949} & \replace{9} & \replace{13.70} & \replace{0.87}\\*
\rowcolor{Gray}
...
\nobreakmidrule
& \replace{lrscaf} & \replace{5512518} & \replace{20} & \replace{777919} & \replace{26} & \replace{3.52} & \replace{0.38}\\*
...
\nobreakmidrule
\rowcolor{Gray}
& \replace{lrscaf} & \replace{5823340} & \replace{38} & \replace{559414} & \replace{7} & \replace{5.92} & \replace{1.27}\\*
\rowcolor{Gray}
...
\nobreakmidrule
& \replace{lrscaf} & \replace{5470282} & \replace{8} & \replace{2951488} & \replace{9} & \replace{3.04} & \replace{2.62}\\*
...
\nobreakmidrule
\rowcolor{Gray}
& \replace{lrscaf} & \replace{4260869} & \replace{12} & \replace{3215170} & \replace{8} & \replace{6.69} & \replace{2.27}\\*
\rowcolor{Gray}
...
\nobreakmidrule
& \replace{lrscaf} & \replace{12486884} & \replace{214} & \replace{254587} & \replace{27} & \replace{16.45} & \replace{1.97}\\*
...
\nobreakmidrule
\rowcolor{Gray}
& \replace{lrscaf} & \replace{4678609} & \replace{175} & \replace{376897} & \replace{26} & \replace{3.91} & \replace{2.35}\\*
\rowcolor{Gray}
...
\nobreakmidrule
& \replace{lrscaf} & \replace{5266645} & \replace{128} & \replace{429353} & \replace{27} & \replace{9.72} & \replace{1.19}\\*
...
\nobreakmidrule
\rowcolor{Gray}
& \replace{lrscaf} & \replace{2231488} & \replace{10} & \replace{683404} & \replace{6} & \replace{11.96} & \replace{1.37}\\*
\rowcolor{Gray}
