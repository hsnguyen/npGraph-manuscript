...
\addnew{In addition, the release of Read Until API enables direct control to the actual molecular reading process which has paved the way for customized selective and/or enrichment sequencing on ONT platforms. To function properly, methods using this protocol must implement rapid-responsed operations on the streaming data, for example in ReadFish~\cite{Payne2020}.}
