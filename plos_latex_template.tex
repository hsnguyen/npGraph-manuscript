...
\centering
\caption{Comparison of assemblies produced in batch-mode using \npgraph{} and other hybrid assembly methods on representative \unicycler{}`s synthetic data downloaded from \url{https://cloudstor.aarnet.edu.au/plus/index.php/s/dzRCaxLjpGpfKYW}} 
...
\paragraph*{S2 Fig.}
\label{S2_Fig}
Alignments of an \emph{Enterobacter~cloacae} reference genome to assembly sequences generated by  (a)~\unicycler{} and (b)~\npgraph{}. The former suggests a structural variant, the latter is virtually an 1-to-1 mapping.
